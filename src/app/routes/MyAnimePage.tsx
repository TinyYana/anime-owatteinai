...
export function MyAnimePage() {
  ...
  const sortedList = [...list].sort(
    (a, b) => statusRank[a.status] - statusRank[b.status] || b.updatedAt.localeCompare(a.updatedAt),
  );
...
function MyAnimeRow({
  ...
  return (
    <li className="group grid grid-cols-[4.75rem_minmax(0,1fr)] gap-3 py-4 md:grid-cols-[5.5rem_minmax(0,1fr)] md:gap-5 md:py-5">
